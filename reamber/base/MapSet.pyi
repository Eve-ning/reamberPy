...
class MapSet(Generic[NoteListT, HitListT, HoldListT, BpmListT, MapT]):
    ...
    def __init__(
        self, maps: List[Map[NoteListT, HitListT, HoldListT, BpmListT]]
    ): ...
    ...
    def __getitem__(self, item: int | slice | Type[T]) -> Map:
        Map | Sequence[Map] | List[Type[T]]
    def __setitem__(self, key: Union[Any, type], value): ...
    def deepcopy(self) -> MapSet: ...
    def describe(
        self, rounding: int = 2, unicode: bool = False
    ) -> List[str]: ...
