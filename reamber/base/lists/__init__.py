...
E.g. class BpmList(List[BpmObject], TimedList, ...)
...
2.1 Union of List
    Consider this
    svs: Union[OsuSvList, List[OsuSvObject]] = field(default_factory=lambda: OsuSvList())
    
    Union here is required else PyCharm will complain that you cannot allocate a List[OsuSvObject] to svs
