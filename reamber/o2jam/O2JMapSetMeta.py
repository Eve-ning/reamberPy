...
class O2JMapSetMeta:
    ...
    event_count        : List[int] = field(default_factory=lambda: [])  # INT[3]   # 12      # 28      # 40
    note_count         : List[int] = field(default_factory=lambda: [])  # INT[3]   # 12      # 40      # 52
    measure_count      : List[int] = field(default_factory=lambda: [])  # INT[3]   # 12      # 52      # 64
    package_count      : List[int] = field(default_factory=lambda: [])  # INT[3]   # 12      # 64      # 76
    ...
    note_offset        : List[int] = field(default_factory=lambda: [])  # INT[3]   # 12      # 284     # 296
