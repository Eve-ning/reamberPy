...
class OsuMapObjectMetaGeneral:
    ...
    mode: int = OsuMapObjectMode.MANIA
...
@dataclass
class OsuMapObjectMetaMetadata:
    title: str = ""
    titleUnicode: str = ""
    artist: str = ""
    artistUnicode: str = ""
...
@dataclass
class OsuMapObjectMetaDifficulty:
...
@dataclass
class OsuMapObjectMetaEvents:
    backgroundFileName: str = ""


@dataclass
class OsuMapObjectMeta(OsuMapObjectMetaGeneral,
                       OsuMapObjectMetaEditor,
                       OsuMapObjectMetaMetadata,
                       OsuMapObjectMetaDifficulty,
                       OsuMapObjectMetaEvents):
