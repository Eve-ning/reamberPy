...
@pytest.mark.parametrize(
    ...
    [
        ([0, MIN_DIST], [], [], [MIN_DIST], [0], [LN_AS_HIT]),
        ([0, MIN_DIST - 1], [], [], [0, MIN_DIST - 1], [], []),
        ([], [0, MIN_DIST], [100, 100], [], [0, MIN_DIST], [LN_AS_HIT, 100]),
        ([], [0, MIN_DIST - 1], [100, 100], [0], [MIN_DIST - 1], [100]),
        ([0], [MIN_DIST], [100], [], [0, MIN_DIST], [LN_AS_HIT, 100]),
        ([MIN_DIST], [0], [100], [MIN_DIST], [0], [LN_AS_HIT]),
    ],
    ids=[
        "Hit-Hit",
        "Hit-Hit(Mini LN)",
