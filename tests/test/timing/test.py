    ...
    def test_by_snap(self):
        ...
        self.assertEqual(
            [BpmChange(bpm=200, beats_per_measure=Fraction(4, 1), offset=100, measure=0, beat=0, slot=Fraction(0, 1)),
             BpmChange(bpm=200, beats_per_measure=Fraction(3, 1), offset=1300.0, measure=1, beat=0,
                       slot=Fraction(0, 1)),
             BpmChange(bpm=300, beats_per_measure=Fraction(3, 1), offset=2200.0, measure=2, beat=0,
                       slot=Fraction(0, 1)),
             BpmChange(bpm=300, beats_per_measure=Fraction(4, 1), offset=2800.0, measure=3, beat=0,
                       slot=Fraction(0, 1)),
             BpmChange(bpm=200, beats_per_measure=Fraction(4, 1), offset=3000.0, measure=3, beat=1,
                       slot=Fraction(0, 1)),
             BpmChange(bpm=300, beats_per_measure=Fraction(4, 1), offset=3600.0, measure=3, beat=3,
                       slot=Fraction(0, 1)),
             BpmChange(bpm=200, beats_per_measure=Fraction(4, 1), offset=3800.0, measure=4, beat=0,
                       slot=Fraction(0, 1)),
             BpmChange(bpm=100, beats_per_measure=Fraction(4, 1), offset=4250.0, measure=4, beat=1,
                       slot=Fraction(1, 2)),
             BpmChange(bpm=300, beats_per_measure=Fraction(3, 1), offset=5750.0, measure=5, beat=0,
                       slot=Fraction(0, 1))],
            tm.bpm_changes)
