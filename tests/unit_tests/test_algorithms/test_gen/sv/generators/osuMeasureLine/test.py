...
from reamber.algorithms.generate.sv.generators.svOsuMeasureLineA import \
    sv_osu_measure_line_a
from reamber.algorithms.generate.sv.generators.svOsuMeasureLineB import \
    sv_osu_measure_line_b
from reamber.algorithms.generate.sv.generators.svOsuMeasureLineMD import \
    sv_osu_measure_line_md, SvOsuMeasureLineEvent


def test_a():
    seq = sv_osu_measure_line_a(
        first_offset=5000,
        last_offset=20000,
...
def testMD():
    ...
    svs, bpms = sv_osu_measure_line_md(events, first_offset=10000,
                                       last_offset=20000, end_bpm=200,
                                       scaling_factor=1.55,
                                       padding_size=10)
